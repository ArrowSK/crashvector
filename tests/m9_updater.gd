...
func _test_canonical_version() -> void:
	...
	_expect(version == "0.9.0-beta.1", "Canonical application version should be 0.9.0-beta.1")
...
func _test_semantic_versions() -> void:
	...
	_expect(SemanticVersion.should_offer("0.8.0-beta.3", "0.9.0-beta.1"), "verified M18 beta should accept the M19-M22 release candidate")
