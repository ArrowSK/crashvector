...
The current `main` source is implemented through M23. The full current regression stack, runtime presentation review and native package gates have run successfully; the current verified public package is `0.9.0-beta.4`.
...
The current public packaged version is `0.9.0-beta.4`, matching the M23 source and updater discovery.
