...
func _test_canonical_version() -> void:
	...
	_expect(version == "0.9.0-beta.7", "Canonical application version should be 0.9.0-beta.7")
...
func _test_semantic_versions() -> void:
	...
	_expect(SemanticVersion.should_offer("0.8.0-beta.2", "0.8.0-beta.3"), "beta.2 should accept the packaged updater/Kenney corrective beta.3")
	_expect(SemanticVersion.should_offer("0.8.0-beta.3", "0.9.0-beta.2"), "verified M18 beta should accept the M19-M22 public beta")
	_expect(SemanticVersion.should_offer("0.9.0-beta.1", "0.9.0-beta.2"), "M19-M22 beta.1 should accept the portable-checksum beta.2")
	_expect(SemanticVersion.should_offer("0.9.0-beta.2", "0.9.0-beta.3"), "M22 beta.2 should accept the M23 corrective beta.3")
	_expect(SemanticVersion.should_offer("0.9.0-beta.3", "0.9.0-beta.4"), "M23 beta.3 should accept the wheel and camera corrective beta.4")
	_expect(SemanticVersion.should_offer("0.9.0-beta.4", "0.9.0-beta.5"), "M23 beta.4 should accept the fitted-wheel and tank corrective beta.5")
	_expect(SemanticVersion.should_offer("0.9.0-beta.5", "0.9.0-beta.6"), "M23 beta.5 should accept the visual-contact corrective beta.6")
	_expect(SemanticVersion.should_offer("0.9.0-beta.6", "0.9.0-beta.7"), "M23 beta.6 should accept the verified contact-correction beta.7")
