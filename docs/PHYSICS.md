...
The current `main` source is implemented through M23. The full current regression stack has executed successfully, and the verified public package is `0.9.0-beta.3`.
