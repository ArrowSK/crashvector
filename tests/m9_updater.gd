...
func _test_canonical_version() -> void:
	...
	_expect(version == "0.9.0-beta.8", "Canonical application version should be 0.9.0-beta.8")
...
func _test_semantic_versions() -> void:
	...
	_expect(SemanticVersion.should_offer("0.9.0-beta.7", "0.9.0-beta.8"), "beta.7 should accept the verified contact-correction beta.8")
